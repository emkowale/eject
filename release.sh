...
OWNER="emkowale"
REPO="eject"
PLUGIN_SLUG="eject"      # folder name inside the zip
MAIN_FILE="eject.php"    # main plugin file (repo root or under PLUGIN_SLUG/)
# ==============================================================================
...
# --- Locate repo root (stick to script directory) ----------------------------
